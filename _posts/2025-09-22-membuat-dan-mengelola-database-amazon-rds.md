...
![Halaman layanan AWS untuk memilih Amazon RDS](../assets/img/posts/cloud/amazon-rds/aurora-and-rds.webp)
...
![Dashboard Amazon RDS dengan opsi Create Database](../assets/img/posts/cloud/amazon-rds/database-console.webp)
...
![Formulir pembuatan database dengan pilihan engine database](../assets/img/posts/cloud/amazon-rds/create-database.webp)
...
![Pengaturan kredensial master username dan password](../assets/img/posts/cloud/amazon-rds/credentials-settings.webp)
...
![Konfigurasi konektivitas jaringan dan security group](../assets/img/posts/cloud/amazon-rds/db-and-vpc-group.webp)
...
![Instance database berhasil dibuat dengan status Available](../assets/img/posts/cloud/amazon-rds/hasil.webp)
...
![Detail informasi konektivitas dan keamanan database](../assets/img/posts/cloud/amazon-rds/connectivity-and-security.webp)
...
![Konfigurasi inbound rules pada security group untuk akses database](../assets/img/posts/cloud/amazon-rds/sg-db.webp)
...
![Menu Actions untuk membuat snapshot manual](../assets/img/posts/cloud/amazon-rds/take-snapshot.webp)
...
![Form penamaan snapshot database](../assets/img/posts/cloud/amazon-rds/snapshot-preferences.webp)
...
![Snapshot berhasil dibuat dengan status Available](../assets/img/posts/cloud/amazon-rds/hasil-snapshot.webp)
...
![Daftar snapshot yang tersedia untuk database instance](../assets/img/posts/cloud/amazon-rds/demo-snapshot.webp)
