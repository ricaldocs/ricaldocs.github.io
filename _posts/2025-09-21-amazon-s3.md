...
![Antarmuka Konsol Amazon S3 di AWS Management Console](../assets/img/posts/cloud/aws-s3/amazon-s3.webp)
...
![General Configuration](../assets/img/posts/cloud/aws-s3/create-bucket.webp)
...
![Daftar bucket S3 yang menunjukkan bucket yang baru dibuat](../assets/img/posts/cloud/aws-s3/my-bucket.webp)
...
![Tombol 'Upload' di dalam halaman detail bucket](../assets/img/posts/cloud/aws-s3/upload.webp)
...
![Dialog pemilihan file dari sistem lokal pengguna](../assets/img/posts/cloud/aws-s3/add-files.webp)
...
![Tombol 'Upload' akhir untuk memulai transfer data](../assets/img/posts/cloud/aws-s3/upload-button.webp)
...
![Status pengunggahan yang menunjukkan proses yang berhasil](../assets/img/posts/cloud/aws-s3/status.webp)
...
![Halaman detail properti untuk sebuah objek yang diunggah](../assets/img/posts/cloud/aws-s3/properties.webp)
...
![Tampilan objek di dalam sebuah bucket S3](../assets/img/posts/cloud/aws-s3/hasil.webp)
...
Tab "Permissions" pada halaman objek memungkinkan Anda mengonfigurasi kontrol akses. Dalam setelan default, status akses objek akan ditampilkan sebagai "AccessDenied".
    ...
    ![Tab izin yang menunjukkan status akses 'AccessDenied' secara default](../assets/img/posts/cloud/aws-s3/restricted.webp)
...
![Tombol 'Delete' untuk menghapus objek yang dipilih](../assets/img/posts/cloud/aws-s3/delete-objects.webp)
...
![Error Akses Ditolak](../assets/img/posts/cloud/aws-s3/accessdenied.webp)
...
![Panel Izin Bucket](../assets/img/posts/cloud/aws-s3/permissions.webp)
...
![Nonaktifkan Pemblokiran Akses Publik](../assets/img/posts/cloud/aws-s3/unchecklist-block-public-access.webp)
...
![Editor Kebijakan Bucket](../assets/img/posts/cloud/aws-s3/edit-bucket-policy.webp)
...
![Contoh Kebijakan](../assets/img/posts/cloud/aws-s3/policy-examples.webp)
...
![Generator Kebijakan](../assets/img/posts/cloud/aws-s3/policy-generator.webp)
...
![Dokumen JSON Kebijakan](../assets/img/posts/cloud/aws-s3/json-document.webp)
...
![Kebijakan Bucket Diterapkan](../assets/img/posts/cloud/aws-s3/bucket-policy.webp)
...
![Bucket Publik](../assets/img/posts/cloud/aws-s3/bucket-public.webp)
...
1. **Masuk ke Properties Bucket**
   ...
   ![Antarmuka Properties Bucket S3](../assets/img/posts/cloud/aws-s3/s3-website/properties.webp)
...
3. **Konfigurasi Endpoint Website**
   ...
   ![Menu Static Website Hosting](../assets/img/posts/cloud/aws-s3/s3-website/static-web-hosting.webp)
   _Opsi Static website hosting pada Properties bucket_

   ![Endpoint Website yang Terbentuk](../assets/img/posts/cloud/aws-s3/s3-website/bucket-website-endpoint.webp)
...
2. Pastikan kedua file berada pada level direktori yang sama (root bucket)
   ...
   ![Daftar File dalam Bucket S3](../assets/img/posts/cloud/aws-s3/s3-website/list-file.webp)
...
![Akses Melalui Website Endpoint](../assets/img/posts/cloud/aws-s3/s3-website/bucket-website-endpoint-link.webp)
